@extends('website.layouts.app', ['meta' => ['title' => 'Cart']]) 
@php
    $subtotal = 0;
    $shippingCharge = 50;
                                    ...
                                    <table>
                                        ...
                                        <tbody>
                                            @foreach ($cartItems as $key => $product)
                                                @php $subtotal += $product->qty * $product->price; @endphp
                                                        ...
                                                        <div class="d-flex gap-3">
                                                            ...
                                                            <div>
                                                                <div class="name-product">
                                                                    {{ $product->name }} @if ($product->options->v_titles)
                        ...
                        <form action="#" method="get" accept-charset="utf-8">
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="btn-radio">
                                            <div class="">
                                                ...
                                                <span>Flat Rate: <span id="flatrate">{{ number_format($shippingCharge) }} ৳</span>
                                                    Taka</span>
                                            </div>
                                            <div class="radio-info">
                                                <input type="radio" id="inside_dhaka" name="radio-flat-rate"
                                                    value="50" onclick="setFlat(50);" checked />
                                                <label for="inside_dhaka"><span>Inside Dhaka</span></label>
                                            </div>
                                            <div class="radio-info">
                                                <input type="radio" id="outside_dhaka" name="radio-flat-rate"
                                                    value="100" onclick="setFlat(100);" />
                                    ...
                                    <tr>
                                        @php $total = $subtotal + $shippingCharge; @endphp
                                        <td>Total</td>
