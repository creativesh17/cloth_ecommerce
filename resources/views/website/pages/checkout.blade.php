    ...
    <section class="flat-checkout">
        <div class="container">
            ...
            <form action="{{ url('/checkout') }}" method="POST" class="checkout" accept-charset="utf-8">
                ...
                <div class="row">
                    <div class="col-md-7">
                        @if (Auth::check() && count(auth()->user()->order_addresses))
                            @php
                                $get_user = auth()->user()->order_addresses[
                                    auth()->user()->order_addresses->count() - 1
                                ];
                            @endphp
                        @endif
                                            ...
                                            <div class=" p_star {{ $errors->has('ship_name') ? ' has-error' : '' }}">
                                                <div class="field-one-half">
                                                    ...
                                                    <input type="text" id="ship_name" name="ship_name"
                                                        value="{{ $get_user->first_name ?? '' }}" placeholder="Ali Khan">
                                        ...
                                        <div class="col-lg-6 p-2">
                                            <div class=" {{ $errors->has('division') ? ' has-error' : '' }} ">
                                                <div class="field-one-half">
                                                    ...
                                                    <select onchange="set_district(event.target.value)" id="division"
                                                        name="division" class="form-control"></select>
                                        ...
                                        <div class="col-lg-12 p-2">
                                            <div class="{{ $errors->has('ship_address') ? ' has-error' : '' }}">
                                                <label for="ship_address" class="mb-4  d-block">Address
                                                    ...
                                                    <sub class="mt-2 d-block">( eg: baily road, 16A, house 34, 4th floor
                                                        )</sub>
                                                </label>
                                                <textarea id="add1" name="ship_address" class="form-control">{{ $get_user->address ?? '' }}</textarea>
                    ...
                    <div class="col-md-5">
                        <div class="cart-totals style2">
                            ...
                            <table class="table table-bordered product check_out_page_cart_list">
                                <thead>
                                    <tr>
                                        <th>Product</th>
                                        <th>Price</th>
                                ...
                                <tbody>
                                    @foreach ($cartItems as $key => $product)
                                        ...
                                        <tr>
                                            ...
                                            <td class="no-wrap p-1">{{ number_format($product->price) }} ৳ x
                                                {{ $product->qty }}</td>
                                            <td class="no-wrap p-1">{{ number_format($product->price * $product->qty) }} ৳
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                                            ...
                                            <div class="">
                                                <label for="inside_dhaka">
                                                    <input type="radio" id="inside_dhaka" name="shipping_method"
                                                        value="inside_dhaka" onchange="setFlat({{ $home_delivery_value }});"
                                                        checked>
                                                    <span>Inside Dhaka - {{ $home_delivery_value }} ৳</span>
                                                </label>
                                            </div>
                                            <div class="">
                                                <label for="outside_dhaka">
                                                    <input type="radio" id="outside_dhaka" name="shipping_method"
                                                        value="outside_dhaka"
                                                        onchange="setFlat({{ $outside_dhaka_value }});">
                                                    <span class="ms-1 ml-1">
                            ...
                            <div class="checkbox {{ $errors->has('check-terms') ? ' has-error' : '' }}">
                                <input type="checkbox" id="check-terms" name="check-terms" checked>
